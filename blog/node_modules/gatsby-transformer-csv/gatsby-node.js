...
const convertToJson = (data, options) => csv(options).fromString(data).then(jsonData => jsonData, new Error(`CSV to JSON conversion failed!`));
...
async function onCreateNode({
  ...
  async function transformObject(obj, i) {
    ...
    const csvNode = {
      ...obj,
      id: (_obj$id = obj.id) !== null && _obj$id !== void 0 ? _obj$id : createNodeId(`${node.id} [${i}] >>> ${node.extension.toUpperCase()}`),
      children: [],
      parent: node.id,
      internal: {
